...
const icons = {
  navOverview: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><g class="nav-icon-outline"><rect x="3.5" y="3.5" width="6.5" height="6.5" rx="1.5"/><rect x="14" y="3.5" width="6.5" height="6.5" rx="1.5"/><rect x="3.5" y="14" width="6.5" height="6.5" rx="1.5"/><rect x="14" y="14" width="6.5" height="6.5" rx="1.5"/></g><g class="nav-icon-solid" fill="currentColor" stroke="none"><rect x="3" y="3" width="7.5" height="7.5" rx="1.8"/><rect x="13.5" y="3" width="7.5" height="7.5" rx="1.8"/><rect x="3" y="13.5" width="7.5" height="7.5" rx="1.8"/><rect x="13.5" y="13.5" width="7.5" height="7.5" rx="1.8"/></g></svg>',
  navDealers: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><g class="nav-icon-outline"><path d="M4 20.5h16M5.5 20.5V8.5h13v12M8 8.5V4h8v4.5M9 12h1.5m3 0H15m-6 3.5h1.5m3 0H15M10 20.5v-2.75h4v2.75"/></g><g class="nav-icon-solid" stroke="none"><path fill="currentColor" d="M7 3h10v4h3v14H4V7h3V3Z"/><path fill="#fff" d="M9 5h6v2H9zm-2 5h3v2H7zm7 0h3v2h-3zm-7 4h3v2H7zm7 0h3v2h-3zm-3 3h2v4h-2z"/></g></svg>',
  navAnalysis: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><g class="nav-icon-outline"><path d="M4 20.5h16M6.5 17V11h3v6m2.5 0V5.5h3V17m2.5 0v-8h3v8"/></g><g class="nav-icon-solid" fill="currentColor" stroke="none"><rect x="4" y="11" width="4" height="10" rx="1"/><rect x="10" y="4" width="4" height="17" rx="1"/><rect x="16" y="8" width="4" height="13" rx="1"/></g></svg>',
  navCalendar: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><g class="nav-icon-outline"><rect x="3.5" y="5.5" width="17" height="15" rx="2.5"/><path d="M8 3.5v4M16 3.5v4M3.5 10h17M8 14h.01M12 14h.01M16 14h.01M8 17.5h.01M12 17.5h.01"/></g><g class="nav-icon-solid" stroke="none"><rect x="3" y="5" width="18" height="16" rx="3" fill="currentColor"/><path fill="#fff" d="M3 9h18v2H3zm5-6h2v5H8zm6 0h2v5h-2zm-7 10h3v2H7zm5 0h3v2h-3zm5 0h2v2h-2zM7 17h3v2H7zm5 0h3v2h-3z"/></g></svg>',
  navReports: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><g class="nav-icon-outline"><path d="M6 3.5h8l4 4v13H6zM14 3.5v4h4M9 12h6M9 15.5h6"/></g><g class="nav-icon-solid" stroke="none"><path fill="currentColor" d="M5 2h10l4 4v16H5V2Z"/><path fill="#fff" d="M15 2v5h4v2h-6V2zM8 12h8v2H8zm0 4h8v2H8z"/></g></svg>',
  navHelp: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><g class="nav-icon-outline"><circle cx="12" cy="12" r="8.5"/><path d="M9.75 9.5a2.35 2.35 0 1 1 3.6 1.98c-.9.55-1.35 1.05-1.35 2.27M12 17h.01"/></g><g class="nav-icon-solid" stroke="none"><circle cx="12" cy="12" r="9" fill="currentColor"/><path d="M9.75 9.25a2.5 2.5 0 1 1 3.7 2.2C12.5 12 12 12.6 12 13.75M12 17h.01" fill="none" stroke="#fff" stroke-width="1.8" stroke-linecap="round"/></g></svg>',
  headerSearch: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="10.75" cy="10.75" r="6.75"/><path d="m16 16 4 4"/></svg>',
  headerBell: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M18 9a6 6 0 0 0-12 0c0 6-2.5 6.5-2.5 8h17C20.5 15.5 18 15 18 9ZM9.75 20h4.5"/></svg>',
  headerHelp: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="12" cy="12" r="8.5"/><path d="M9.75 9.5a2.35 2.35 0 1 1 3.6 1.98c-.9.55-1.35 1.05-1.35 2.27M12 17h.01"/></svg>',
  headerMenu: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" aria-hidden="true" focusable="false"><path d="M5 7.5h14M5 12h14M5 16.5h14"/></svg>',
  ...
  median: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h16M7 12h10M10 18h4"/></svg>',
  trendDown: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="m4 7 6 6 4-4 6 6M20 10v5h-5"/></svg>',
  trendUp: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="m4 17 6-6 4 4 6-6M15 9h5v5"/></svg>',
...
function dealersPage() {
  return `<section class="page" aria-labelledby="page-title">
    ...
    <div class="summary-strip"><div class="summary-cell"><span>Rete totale</span><strong>64 dealer</strong></div><div class="summary-cell"><span>Completati</span><strong>44 <small class="trend-up">69%</small></strong></div><div class="summary-cell"><span>Da verificare</span><strong>4 <small style="color:var(--amber)">6%</small></strong></div><div class="summary-cell"><span>Non compilati</span><strong>16 <small style="color:var(--muted)">25%</small></strong></div></div>
