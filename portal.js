(() => {
  ...
  function portalAnalysisPage() {
    ...
    const regionalRange = Math.max(regionalSpread,Math.abs(regionalMax)*.08,1);
    const chartFloor = Math.max(0,regionalMin-regionalRange*.18);
    const chartCeiling = regionalMax+regionalRange*.12;
